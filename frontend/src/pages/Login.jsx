      ...
      <div style={{ background: '#fff', borderRadius: 10, overflow: 'hidden', width: '100%', maxWidth: 'clamp(320px,36vw,460px)', boxShadow: '0 4px 24px rgba(0,0,0,.08)' }}>
        ...
        <div style={{ padding: 'clamp(16px,2.2vw,28px) clamp(20px,2.8vw,36px)', display: 'flex', flexDirection: 'column', gap: 'clamp(12px,1.6vw,20px)' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
            ...
            <button disabled title="Coming soon" style={{ width: '100%', height: 44, background: '#000', border: '1px solid #000', borderRadius: 8, cursor: 'not-allowed', opacity: .5, display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 10, fontSize: 'clamp(13px,1.5vw,15px)', fontWeight: 500, color: '#fff', fontFamily: 'inherit' }}>
